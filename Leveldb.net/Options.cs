...
namespace LevelDB
{
    ...
    public class Options : LevelDBHandle
    {
        ...
        public bool CreateIfMissing
        {
            set
            {
                LevelDBInterop.leveldb_options_set_create_if_missing(this.Handle, value ? (byte)1 : (byte)0);
            }
        }
        ...
        public bool ErrorIfExists
        {
            set
            {
                LevelDBInterop.leveldb_options_set_error_if_exists(this.Handle, value ? (byte)1 : (byte)0);
            }
        }
        ...
        public bool ParanoidChecks
        {
            set
            {
                LevelDBInterop.leveldb_options_set_paranoid_checks(this.Handle, value ? (byte)1 : (byte)0);
            }
        }
        ...
        public long WriteBufferSize
        {
            set
            {
                LevelDBInterop.leveldb_options_set_write_buffer_size(this.Handle, value);
            }
        }
        ...
        public int MaxOpenFiles
        {
            set
            {
                LevelDBInterop.leveldb_options_set_max_open_files(this.Handle, value);
            }
        }
        ...
        public long BlockSize
        {
            set
            {
                LevelDBInterop.leveldb_options_set_block_size(this.Handle, value);
            }
        }
        ...
        public int RestartInterval
        {
            set
            {
                LevelDBInterop.leveldb_options_set_block_restart_interval(this.Handle, value);
            }
        }
        ...
        public CompressionLevel CompressionLevel
        {
            set
            {
                LevelDBInterop.leveldb_options_set_compression(this.Handle, (int)value);
            }
        }

        public bool IsInternalDebugLoggerEnabled
        {
            get; set;
        }
        ...
        public LevelDB.Env _Env
        {
            get; set;
        }

        public LevelDB.Cache _Cache
        {
            get; set;
        }

        public LevelDB.Comparator _Comparator
        {
            get; set;
        }
